...
export const VARER = {
  ...
  hakketkalkun:   { navn: 'Hakket kylling 4-7%', afd: 'kod', enh: 'g', kcal: 118, p: 18, k: 0, f: 5, fib: 0, pakke: 400, mrk: ['kylling'], pris: 2, farve: '#e0b884', alt: 'Hakket kalkun findes sjældent i REMA — hakket kylling er samme vare her' },
  ...
  mozzarella:     { navn: 'Revet mozzarella',        afd: 'kol', enh: 'g', kcal: 280, p: 25, k: 2, f: 21, fib: 0, pakke: 200, mrk: ['laktose'], pris: 2, farve: '#fbf3dd' },
  ...
  hvidlog:        { navn: 'Hvidløg (fed)',           afd: 'groent', enh: 'stk', kcal: 4, p: 0.2, k: 1, f: 0, fib: 0.1, pakke: 10, mrk: [], pris: 1, farve: '#efe8d8', alt: 'Et hoved har typisk 10-12 fed' },
  ...
  kikaerter:      { navn: 'Kikærter (dåse)',         afd: 'kolonial', enh: 'g', kcal: 141, p: 8, k: 17, f: 2.6, fib: 6, pakke: 240, mrk: [], pris: 1, farve: '#d8c184' },
  ...
  soja:           { navn: 'Sojasauce',               afd: 'kolonial', enh: 'ml', kcal: 57, p: 9, k: 5, f: 0, fib: 0, pakke: 250, mrk: ['gluten'], pris: 2, fast: true, farve: '#4a2f1e' },
  ...
  honning:        { navn: 'Honning',                 afd: 'kolonial', enh: 'g', kcal: 322, p: 0, k: 80, f: 0, fib: 0, pakke: 425, mrk: [], pris: 2, fast: true, farve: '#dda52c' },
...
export const MARKORER = [
  ...
  { id: 'kylling', navn: 'Kylling og fjerkræ' },
